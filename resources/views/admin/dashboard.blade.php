                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ request()->is('admin/user*') ? 'show' : '' }}" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('admin/user/pppoe') ? 'active' : '' }}" href="{{ route('admin.user.pppoe') }}">PPPoE</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('admin/user/hotspot') ? 'active' : '' }}" href="{{ route('admin.user.hotspot') }}">Hotspot</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 stretch-card transparent">
                                    <div class="card card-tale">
                                        <div class="card-body">
                                            <p class="mb-4">Today’s Earnings</p>
                                ...
                                <div class="col-md-6 mb-4 stretch-card transparent">
                                    <div class="card card-dark-blue">
                                        <div class="card-body">
                                            <p class="mb-4">Monthly Earnings</p>
